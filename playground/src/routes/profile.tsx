...
// Preloading during SSR ensures the redirect fires server-side before the
// page shell is sent, so unauthenticated requests get a proper 302.
export const route = {
  preload: () => getSessionData(),
};
